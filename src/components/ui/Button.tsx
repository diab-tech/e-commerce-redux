...
const buttonVariants = cva(
  "flex items-center justify-center rounded-md font-medium text-white duration-300 cursor-pointer disabled:bg-indigo-400 disabled:hover:bg-indigo-400 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
    ...
    >
      {isLoading ? (
        <div className="flex items-center">
          ...
          Loading... {/* نص اختياري أثناء التحميل */}
        </div>
      ) : (
        children
      )}
